  ...
  <section class="container mt-3">
    ...
    <form @submit.prevent="onSubmit">
      <div class="form-group">
        ...
        <input id="series-name" v-model.trim="form.name" class="form-control" required type="text" />
      </div>

      <div class="form-group">
        <label for="series-nb-races">Number of races</label>
        <input id="series-nb-races" v-model.number="form.nbRaces" class="form-control" min="1" required type="number" />
      </div>

      <div class="form-group">
        <label for="series-nb-races-count">Number of races to count</label>
        <input id="series-nb-races-count" v-model.number="form.nbRacesToCount" class="form-control" min="1" required type="number" />
      </div>

      <div class="form-group">
        <label for="series-race-class-id">Race class</label>
        <select id="series-race-class-id" v-model.number="form.raceClassId" class="form-control" required>
